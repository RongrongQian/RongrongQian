...
I possess a comprehensive skill set in data analysis and application development, including:
* **Statistical Software:** R, Python, SAS (Certified Specialist), Power BI, SQL.
* **Applied Projects:** Developed statistical metrics and visualizations to assist a client in improving their diving judge assessment application; led teams to create interactive data narratives (e.g., US Chronic Health Mortality Indicators in R Shiny); and designed dynamic visualization tools (e.g., Tornado Visualization using SAS Macro).
  
As a Volunteer Statistical Consultant, I excel at communicating complex statistical concepts to non-technical clients, translating business questions into rigorous analytical strategies.
